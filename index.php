...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div id="slides">
                ...
                $items = count($projectimg);
                $i = 0;

                while($i < $items){
                  echo <<<EOT
                  <div class="slide">
                  <div class = "project"><img src='$projectimg[$i]'></div>
                    <p>$title[$i] <br> $desc[$i]  <br> $student[$i] <br>  $opleiding[$i]</p>      
                    <div class = "student"><img src='$studentimg[$i]'></div>
                  </div>
EOT;
                  $i++;
