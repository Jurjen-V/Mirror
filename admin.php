    ...
    <main>
        <table>
            ...
            <?php foreach ($stmt as $row) {
			    ?><tr><td><?php echo $row["email_address"];?></td>
			    <td><?php echo $row["email_status"];?> </td>
			    <td><?php echo $row["HasAcc"];?> </td>
			    <td><?php echo $row["ShopName"];?></td>
			    <td><?php echo $row["NumberSHops"];?> </td>
			    <td><?php echo $row["Branche"];?> </td>
			    <td><?php echo $row["Name"];?></td>
			    <td><?php echo $row["PhoneNumber"];?> </td>
			    <td><?php echo $row["Place"];?> </td>
			    <td><?php echo $row["CallPermission"];?></td>
			    <td><?php echo $row["FeedbackPermission"];?></td></tr><?php
			}?>
               <td><?php // actionButtons(); ?>    <div class="actions">
